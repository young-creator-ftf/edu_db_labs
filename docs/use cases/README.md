...
<table> <tr><td><b>ID</b></td><td><code>ConfigureSystem</code></td></tr> <tr><td><b>Назва:</b></td><td>Редагувати налаштування системи</td></tr> <tr><td><b>Учасники:</b></td><td>Адміністратор, система</td></tr> <tr><td><b>Передумови:</b></td><td>Система доступна, адміністратор авторизований</td></tr> <tr><td><b>Результат:</b></td><td>Налаштування оновлені</td></tr> <tr><td><b>Виключні ситуації:</b></td> <td> - ConfigureSystem_InvalidData_EXC — некоректні значення<br/> - ConfigureSystem_CancelButton_EXC — натиснуто “Відміна”<br/> </td> </tr> </table>


@startuml
|Адміністратор|
start;
:Натискає "Налаштування системи";

|Система|
:Відкриває панель параметрів;

|Адміністратор|
:Редагує параметри (час резервного копіювання,\nмакс. розмір файлів, пошта);
:Натискає "Зберегти";
...
<table> <tr><td><b>ID</b></td><td><code>ViewLogs</code></td></tr> <tr><td><b>Назва:</b></td><td>Перегляд системних логів</td></tr> <tr><td><b>Учасники:</b></td><td>Адміністратор, система</td></tr> <tr><td><b>Передумови:</b></td><td>Адміністратор має доступ до логів</td></tr> <tr><td><b>Результат:</b></td><td>Логи виведено на екран</td></tr> <tr><td><b>Виключні ситуації:</b></td> <td> - ViewLogs_NoLogsFound_EXC — логи відсутні<br/> </td> </tr> </table>


@startuml
|Адміністратор|
start;
:Переходить у розділ "Журнали";

|Система|
:Завантажує останні записи;
...
<table> <tr><td><b>ID</b></td><td><code>BanUser</code></td></tr> <tr><td><b>Назва:</b></td><td>Заблокувати користувача</td></tr> <tr><td><b>Учасники:</b></td><td>Адміністратор, система</td></tr> <tr><td><b>Передумови:</b></td><td>Користувач порушив правила</td></tr> <tr><td><b>Результат:</b></td><td>Користувача заблоковано</td></tr> <tr><td><b>Виключні ситуації:</b></td> <td> - BanUser_NotFound_EXC — такого користувача не існує<br/> - BanUser_AlreadyBanned_EXC — користувач уже заблокований<br/> - BanUser_CancelButton_EXC — натиснуто “Відміна”<br/> </td> </tr> </table>

@startuml
|Адміністратор|
start;
:Переходить у розділ "Користувачі";

|Система|
:Відображає список користувачів;

|Адміністратор|
:Обирає користувача і натискає "Заблокувати";
:Вказує причину;
:Натискає "Підтвердити";
